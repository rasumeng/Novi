...
from .state import ResearchState, append_error, should_stop
...
class ResearchGraph:
    ...
    def _node_decompose(self, state: dict) -> dict:
        ...
        state.setdefault("stream_events", []).append({"phase": "understanding"})
    ...
    def _node_search(self, state: dict) -> dict:
        ...
        state.setdefault("stream_events", []).append({"phase": "searching"})
        bundle = search(query)
    ...
    def _node_evaluate(self, state: dict) -> dict:
        ...
        state.setdefault("stream_events", []).append({"phase": "evaluating"})
        gaps: list[str] = []
    ...
    def _node_synthesize(self, state: dict) -> dict:
        ...
        state["messages"] = msgs
        state.setdefault("stream_events", []).append({"phase": "synthesizing"})
