...
import { fetchKnowledgeOverview } from '@/services/cozmo'
...
export function AgentSettings({ config, setConfig, setDirty }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <p className="text-xs text-base-500 mb-2">How Cozmo behaves when working autonomously. Changes save automatically.</p>
        <div className="space-y-2">
          <div className="p-3 rounded-xl bg-base-800/50 border border-base-700">
            ...
            <p className="text-xs text-base-500 mb-2">Additional guidance Cozmo follows whenever it's working autonomously.</p>
            <textarea
    ...
    <div className="p-4 rounded-2xl border border-base-700 bg-base-800/40">
      <div className="flex items-center gap-2 mb-1">
        ...
        <div className="flex-1">
          <p className="text-sm font-semibold text-base-100">What Cozmo knows about you</p>
          <p className="text-xs text-base-500">
            Derived context, updated as you interact. Read-only — sourced from Cozmo's memory.
          </p>
        </div>
        <button
      ...
      {entries.length === 0 ? (
        <p className="text-xs text-base-500 mt-3">
          Cozmo hasn't derived much context yet. Keep talking — this fills in as Cozmo learns your preferences.
        </p>
      ) : (
