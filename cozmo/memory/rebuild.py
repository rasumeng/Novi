...
Run once after switching embedding backends:
    ...
    python -m cozmo.memory.rebuild            # rebuild under ~/.cozmo
    python -m cozmo.memory.rebuild --home <dir>
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(prog="cozmo.memory.rebuild")
    parser.add_argument(
        "--home",
        default=str(Path.home() / ".cozmo"),
        help="profile directory to rebuild (default: ~/.cozmo)",
    )
