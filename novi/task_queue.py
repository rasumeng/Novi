...
log = logging.getLogger("novi.taskqueue")

TASKS_DIR = app_home() / "tasks"
...
class Task:
    def __init__(self, id: str, description: str, prompt: str,
        ...
        self.goal = goal
        self.mode = mode
        self.novi_task_id = novi_task_id
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "goal": self.goal,
            "mode": self.mode,
            "novi_task_id": self.novi_task_id,
        }
    ...
    def from_dict(cls, d: dict) -> "Task":
        return cls(
            ...
            # Legacy records saved before the Novi rebrand used "cozmo_task_id".
            novi_task_id=d.get("novi_task_id", d.get("cozmo_task_id", "")),
        )
