...
//
// Designed as an "important moment": it explains WHY Novi needs permission and
...
/** Plain-language description of the action Novi wants to perform. */
  ...
  const body = (
    <div>
      <p className="text-[13px] text-base-200 leading-relaxed">
        Novi wants to <span className="font-medium text-base-100">{action}</span>.
      </p>
        ...
        >
          <div className="flex items-center gap-2.5 mb-4">
            ...
            <div>
              ...
              <p className="text-[11px] text-base-500">Novi needs your approval to continue</p>
            </div>
          </div>
          {body}
        </motion.div>
