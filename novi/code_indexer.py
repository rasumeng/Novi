...
# ".cozmo" kept so projects created before the Novi rebrand stay scannable.
IGNORE_DIRS = {".git", "__pycache__", "node_modules", ".venv", "venv", ".novi", ".cozmo", "target", "build", "dist"}
...
class ProjectIndex:
    ...
    def __init__(self, project_root: str | Path, embed_model: str | EmbeddingService | None = None):
        ...
        self.store = LanceStore(
            uri=str(app_home() / "project_index" / project_key),
